...
//   // mesh.scale.set(video.width / window.innerWidth, 1.0, 1.0);
//   // },
//
...
//     console.log(camera);
//
//     gui.add(options, "x").onChange((e) => {
//       camera.position.x = e;
//     });
//     gui.add(options, "y").onChange((e) => {
//       camera.position.y = e;
//     });
//     gui.add(options, "z").onChange((e) => {
//       camera.position.z = e;
//     });
//
//     function getXFOV() {
...
//       mesh.material.uniforms.uTime.value = e;
//     });
//     mesh.material.uniforms.uTime.value = 4;
//
//     setTimeout(() => {
...
//
//     function myFunction() {
//       mesh.material.uniforms.uWaveLength.value > 0 &&
//         (mesh.material.uniforms.uWaveLength.value -= 0.2);
...
//     "../../img/content/SPCMN_4636_A 1.webp",
//     (tex) => {
//       tex.needsUpdate = true;
